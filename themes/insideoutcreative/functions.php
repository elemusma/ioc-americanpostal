...
function american_postal_stylesheets() {
...
add_action('wp_enqueue_scripts', 'american_postal_stylesheets');
// for footer
function american_postal_stylesheets_footer() {
...
function american_postal_menus() {
...
add_action('after_setup_theme', 'american_postal_menus');
